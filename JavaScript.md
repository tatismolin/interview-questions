...
|5  | [What is the difference between JavaScript and Jscript?](#what-is-the-difference-between-javascript-and-sscript?) |
|6  | [What is the difference between JavaScript and TypeScript?](#what-is-the-difference-between-javajcript-and-typescript?) |
...
16. What is NaN?
Not a number. When JavaScript is unable to perform operation on not a number. NaN’s type is a Number.
...
58. How to embed JavaScript into HTML?
	<script src="app.js"></script> at the bottom of the body.
...
65. What's the difference between event.preventDefault() and event.stopPropagation() methods?
...
66. What is Asynchrony in JavaScript?
...
67. What is the difference between single and multi-threaded processes?
...
68. What is async/await and how does it work?
...
70. What is promise in JavaScript?
...
73. What is the difference between Local storage & Session storage?
...
74. What are JavaScript Cookies?
...
75. What are errors in JavaScript?
